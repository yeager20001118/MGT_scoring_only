...
def experiment(args):
    ...
    if args.reference_model_name != args.scoring_model_name:
        reference_tokenizer = load_tokenizer(args.reference_model_name, args.dataset, args.cache_dir, args.hf_token)
        reference_model = load_model(args.reference_model_name, args.device, args.cache_dir, args.hf_token)
